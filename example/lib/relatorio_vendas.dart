...
const vendasPorMes = {'Jan': 12500.0, 'Fev': 9800.0, 'Mar': 15200.0, 'Abr': 11000.0, 'Mai': 17400.0, 'Jun': 16100.0};
        ...
        child: Row(
          children: [
            ...
            const Expanded(
              child: Text(
                'Relatório de Vendas',
                style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: _azul),
              ),
            ),
      ...
      build: (ctx) => [
        Row(
          children: [
            ...
            _indicador(
              'Ticket médio',
              reais(pedidos.map((p) => p.valor).reduce((a, b) => a + b) / pedidos.length),
              Icons.trending_up,
            ),
          ],
        ),
