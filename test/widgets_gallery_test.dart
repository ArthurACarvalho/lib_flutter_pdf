      ...
      build: (ctx) => [
        Container(
          ...
          decoration: const BoxDecoration(
            gradient: LinearGradient(colors: [Color(0xFF1F3A5F), Color(0xFF4FC3F7), Color(0xFFFFFFFF)], stops: [0, 0.6, 1]),
        ...
        const Text.rich(TextSpan(children: [
          ...
          TextSpan(text: 'itálico ', style: TextStyle(fontStyle: FontStyle.italic)),
          TextSpan(text: 'sublinhado', style: TextStyle(decoration: TextDecoration.underline, color: Colors.blue)),
