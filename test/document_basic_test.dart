    ...
    doc.addPage(
      PdfPage(
        build: (ctx) => Column(
          ...
          children: [
            Builder(
              builder: (context) => Text('Relatório de Vendas', style: Theme.of(context).textTheme.headlineMedium),
            ),
            ...
            const Card(
              child: ListTile(title: Text('Total'), subtitle: Text('Setembro'), trailing: Text('R\$ 65.900')),
            ),
            const SizedBox(
              height: 260,
              child: GraficoBarras(
